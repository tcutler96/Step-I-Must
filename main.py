...
# change text bounce to be on a ~1 second cycle...
...
# only play spike sound when an alive players steps onto them, not a dead one..
# only draw alive players on the player display layer...
# player movement is carried through after a cutscene plays...
