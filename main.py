...
# shorten splash fade in and only allow skip when fade in finished...
...
# gol background doesnt work with system cursor...
# check what happens when we change a menu option, add check to asseet load function that defaults to first option if it cant find current set option...
# update all existing checks for text element selected to 'left', change text element variable to selected_2 as follow the errors to find copies...
